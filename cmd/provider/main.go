...
import (
	...
	civoip "github.com/crossplane-contrib/provider-civo/internal/controller/civoip"
...
func main() {
	...
	kingpin.FatalIfError(civoip.Setup(mgr, log, rl), "Cannot setup Civo IP controllers")
