...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "objectstore.civo.crossplane.io", Version: "v1alpha1"}

	// SchemeBuilder is used to add go types to the GroupVersionKind scheme
	SchemeBuilder = &scheme.Builder{GroupVersion: schema.GroupVersion{Group: "objectstore.civo.crossplane.io", Version: "v1alpha1"}}
)
