...
func (in *CivoKubernetesSpec) DeepCopyInto(out *CivoKubernetesSpec) {
	*out = *in
	...
	if in.Pools != nil {
		...
		*out = make([]KubernetesClusterPoolConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubernetesClusterPoolConfig) DeepCopyInto(out *KubernetesClusterPoolConfig) {
	*out = *in
	if in.Labels != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubernetesClusterPoolConfig.
func (in *KubernetesClusterPoolConfig) DeepCopy() *KubernetesClusterPoolConfig {
	if in == nil {
		return nil
	}
	out := new(KubernetesClusterPoolConfig)
	in.DeepCopyInto(out)
	return out
}
