...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CivoNetworkConfig) DeepCopyInto(out *CivoNetworkConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CivoNetworkConfig.
func (in *CivoNetworkConfig) DeepCopy() *CivoNetworkConfig {
	if in == nil {
		return nil
	}
	out := new(CivoNetworkConfig)
	in.DeepCopyInto(out)
	return out
}
